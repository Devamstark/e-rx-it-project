...
import { Plus, Trash2, Send, FileText, AlertTriangle, Info, Video, User as UserIcon, Search, Link2, UserPlus, RotateCcw, Save, Download, KeyRound, Calendar, Repeat, X, CheckCircle, MapPin, Phone, Building2, Mic, Activity, Thermometer, Gauge, ShieldCheck, CheckCircle2, Filter, ShieldAlert, Zap, XCircle } from 'lucide-react';
